...
from layers import softmax_with_cross_entropy
...
class Trainer:
    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            print(
                f"Epoch {epoch+1}  Train loss: {batch_losses[-1]:.5f}, Train accuracy: {train_accuracy:.5f}, Val loss: {val_loss:.5f}, val accuracy: {val_accuracy:.5f}"
            )
